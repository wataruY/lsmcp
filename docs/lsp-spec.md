...
#### [$ Notifications and Requests](#dollarRequests)
...
#### [Cancellation Support (:arrow\_right::arrow\_left:)](#cancelRequest)
...
#### [Progress Support (:arrow\_right::arrow\_left:)](#progress)
...
## [Language Server Protocol](#languageServerProtocol)
...
### [Request, Notification and Response Ordering](#messageOrdering)
...
### [Message Documentation](#messageDocumentation)
...
### [Basic JSON Structures](#basicJsonStructures)
...
#### [TextEdit & AnnotatedTextEdit](#textEdit)
...
### [File Resource changes](#resourceChanges)
...
#### [Work Done Progress](#workDoneProgress)
...
##### [Work Done Progress Begin](#workDoneProgressBegin)
...
##### [Work Done Progress Report](#workDoneProgressReport)
...
##### [Work Done Progress End](#workDoneProgressEnd)
...
##### [Initiating Work Done Progress](#initiatingWorkDoneProgress)
...
###### [Client Initiated Progress](#clientInitiatedProgress)
...
###### [Server Initiated Progress](#serverInitiatedProgress)
...
#### [Partial Result Progress](#partialResults)
...
### [Server lifecycle](#lifeCycleMessages)
...
#### [Initialize Request (:leftwards\_arrow\_with\_hook:)](#initialize)
...
#### [Initialized Notification (:arrow\_right:)](#initialized)
...
#### [Register Capability (:arrow\_right\_hook:)](#client_registerCapability)
...
#### [Unregister Capability (:arrow\_right\_hook:)](#client_unregisterCapability)
...
#### [SetTrace Notification (:arrow\_right:)](#setTrace)
...
#### [LogTrace Notification (:arrow\_left:)](#logTrace)
...
#### [Shutdown Request (:leftwards\_arrow\_with\_hook:)](#shutdown)
...
#### [Exit Notification (:arrow\_right:)](#exit)
...
### [Text Document Synchronization](#textDocument_synchronization)
...
[*Client Capability*:](#textDocument_synchronization_cc)
...
[*Server Capability*:](#textDocument_synchronization_sc)
...
#### [DidOpenTextDocument Notification (:arrow\_right:)](#textDocument_didOpen)
...
#### [DidChangeTextDocument Notification (:arrow\_right:)](#textDocument_didChange)
...
#### [WillSaveTextDocument Notification (:arrow\_right:)](#textDocument_willSave)
...
#### [WillSaveWaitUntilTextDocument Request (:leftwards\_arrow\_with\_hook:)](#textDocument_willSaveWaitUntil)
...
#### [DidSaveTextDocument Notification (:arrow\_right:)](#textDocument_didSave)
...
#### [DidCloseTextDocument Notification (:arrow\_right:)](#textDocument_didClose)
...
#### [Renaming a document](#textDocument_didRename)
...
### [Notebook Document Synchronization](#notebookDocument_synchronization)
...
#### [DidOpenNotebookDocument Notification (:arrow\_right:)](#notebookDocument_didOpen)
...
#### [DidChangeNotebookDocument Notification (:arrow\_right:)](#notebookDocument_didChange)
...
#### [DidSaveNotebookDocument Notification (:arrow\_right:)](#notebookDocument_didSave)
...
#### [DidCloseNotebookDocument Notification (:arrow\_right:)](#notebookDocument_didClose)
...
#### [Goto Declaration Request (:leftwards\_arrow\_with\_hook:)](#textDocument_declaration)
...
#### [Goto Definition Request (:leftwards\_arrow\_with\_hook:)](#textDocument_definition)
...
#### [Goto Type Definition Request (:leftwards\_arrow\_with\_hook:)](#textDocument_typeDefinition)
...
#### [Goto Implementation Request (:leftwards\_arrow\_with\_hook:)](#textDocument_implementation)
...
#### [Find References Request (:leftwards\_arrow\_with\_hook:)](#textDocument_references)
...
#### [Prepare Call Hierarchy Request (:leftwards\_arrow\_with\_hook:)](#textDocument_prepareCallHierarchy)
...
#### [Call Hierarchy Incoming Calls (:leftwards\_arrow\_with\_hook:)](#callHierarchy_incomingCalls)
...
#### [Call Hierarchy Outgoing Calls (:leftwards\_arrow\_with\_hook:)](#callHierarchy_outgoingCalls)
...
#### [Prepare Type Hierarchy Request (:leftwards\_arrow\_with\_hook:)](#textDocument_prepareTypeHierarchy)
...
#### [Type Hierarchy Supertypes(:leftwards\_arrow\_with\_hook:)](#typeHierarchy_supertypes)
...
#### [Type Hierarchy Subtypes(:leftwards\_arrow\_with\_hook:)](#typeHierarchy_subtypes)
...
#### [Document Highlights Request (:leftwards\_arrow\_with\_hook:)](#textDocument_documentHighlight)
...
#### [Document Link Request (:leftwards\_arrow\_with\_hook:)](#textDocument_documentLink)
...
#### [Document Link Resolve Request (:leftwards\_arrow\_with\_hook:)](#documentLink_resolve)
...
#### [Hover Request (:leftwards\_arrow\_with\_hook:)](#textDocument_hover)
...
#### [Code Lens Request (:leftwards\_arrow\_with\_hook:)](#textDocument_codeLens)
...
#### [Code Lens Resolve Request (:leftwards\_arrow\_with\_hook:)](#codeLens_resolve)
...
#### [Code Lens Refresh Request (:arrow\_right\_hook:)](#codeLens_refresh)
...
#### [Folding Range Request (:leftwards\_arrow\_with\_hook:)](#textDocument_foldingRange)
...
#### [Selection Range Request (:leftwards\_arrow\_with\_hook:)](#textDocument_selectionRange)
...
#### [Document Symbols Request (:leftwards\_arrow\_with\_hook:)](#textDocument_documentSymbol)
...
#### [Semantic Tokens (:leftwards\_arrow\_with\_hook:)](#textDocument_semanticTokens)
...
#### [Inlay Hint Request (:leftwards\_arrow\_with\_hook:)](#textDocument_inlayHint)
...
#### [Inlay Hint Resolve Request (:leftwards\_arrow\_with\_hook:)](#inlayHint_resolve)
...
#### [Inlay Hint Refresh Request (:arrow\_right\_hook:)](#workspace_inlayHint_refresh)
...
#### [Inline Value Request (:leftwards\_arrow\_with\_hook:)](#textDocument_inlineValue)
...
#### [Inline Value Refresh Request (:arrow\_right\_hook:)](#workspace_inlineValue_refresh)
...
#### [Monikers (:leftwards\_arrow\_with\_hook:)](#textDocument_moniker)
...
#### [Completion Request (:leftwards\_arrow\_with\_hook:)](#textDocument_completion)
...
#### [Completion Item Resolve Request (:leftwards\_arrow\_with\_hook:)](#completionItem_resolve)
...
#### [PublishDiagnostics Notification (:arrow\_left:)](#textDocument_publishDiagnostics)
...
##### [Document Diagnostics(:leftwards\_arrow\_with\_hook:)](#textDocument_diagnostic)
...
##### [Workspace Diagnostics(:leftwards\_arrow\_with\_hook:)](#workspace_diagnostic)
...
##### [Diagnostics Refresh(:arrow\_right\_hook:)](#diagnostic_refresh)
...
#### [Signature Help Request (:leftwards\_arrow\_with\_hook:)](#textDocument_signatureHelp)
...
#### [Code Action Request (:leftwards\_arrow\_with\_hook:)](#textDocument_codeAction)
...
#### [Code Action Resolve Request (:leftwards\_arrow\_with\_hook:)](#codeAction_resolve)
...
#### [Document Color Request (:leftwards\_arrow\_with\_hook:)](#textDocument_documentColor)
...
#### [Color Presentation Request (:leftwards\_arrow\_with\_hook:)](#textDocument_colorPresentation)
...
#### [Document Formatting Request (:leftwards\_arrow\_with\_hook:)](#textDocument_formatting)
...
#### [Document Range Formatting Request (:leftwards\_arrow\_with\_hook:)](#textDocument_rangeFormatting)
...
#### [Document on Type Formatting Request (:leftwards\_arrow\_with\_hook:)](#textDocument_onTypeFormatting)
...
#### [Rename Request (:leftwards\_arrow\_with\_hook:)](#textDocument_rename)
...
#### [Prepare Rename Request (:leftwards\_arrow\_with\_hook:)](#textDocument_prepareRename)
...
#### [Linked Editing Range(:leftwards\_arrow\_with\_hook:)](#textDocument_linkedEditingRange)
...
### [Workspace Features](#workspaceFeatures)

#### [Workspace Symbols Request (:leftwards\_arrow\_with\_hook:)](#workspace_symbol)
...
#### [Workspace Symbol Resolve Request (:leftwards\_arrow\_with\_hook:)](#workspace_symbolResolve)
...
#### [Configuration Request (:arrow\_right\_hook:)](#workspace_configuration)
...
#### [DidChangeConfiguration Notification (:arrow\_right:)](#workspace_didChangeConfiguration)
...
#### [Workspace folders request (:arrow\_right\_hook:)](#workspace_workspaceFolders)
...
#### [DidChangeWorkspaceFolders Notification (:arrow\_right:)](#workspace_didChangeWorkspaceFolders)
...
#### [WillCreateFiles Request (:leftwards\_arrow\_with\_hook:)](#workspace_willCreateFiles)
...
#### [DidCreateFiles Notification (:arrow\_right:)](#workspace_didCreateFiles)
...
#### [WillRenameFiles Request (:leftwards\_arrow\_with\_hook:)](#workspace_willRenameFiles)
...
#### [DidRenameFiles Notification (:arrow\_right:)](#workspace_didRenameFiles)
...
#### [WillDeleteFiles Request (:leftwards\_arrow\_with\_hook:)](#workspace_willDeleteFiles)
...
#### [DidDeleteFiles Notification (:arrow\_right:)](#workspace_didDeleteFiles)
...
#### [DidChangeWatchedFiles Notification (:arrow\_right:)](#workspace_didChangeWatchedFiles)
...
#### [Execute a command (:leftwards\_arrow\_with\_hook:)](#workspace_executeCommand)
...
#### [Applies a WorkspaceEdit (:arrow\_right\_hook:)](#workspace_applyEdit)
...
#### [ShowMessage Notification (:arrow\_left:)](#window_showMessage)
...
#### [ShowMessage Request (:arrow\_right\_hook:)](#window_showMessageRequest)
...
#### [Show Document Request (:arrow\_right\_hook:)](#window_showDocument)
...
#### [LogMessage Notification (:arrow\_left:)](#window_logMessage)
...
#### [Create Work Done Progress (:arrow\_right\_hook:)](#window_workDoneProgress_create)
...
#### [Cancel a Work Done Progress (:arrow\_right:)](#window_workDoneProgress_cancel)
...
#### [Telemetry Notification (:arrow\_left:)](#telemetry_event)
